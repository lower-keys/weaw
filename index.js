...
"externalAdReply": {
"title": `lower-bot`,
"body": "kenalin gw bilek",
"mediaType": 2,
"previewType": `https://youtu.be/BYPN6-gQJx0`,
"thumbnail": fs.readFileSync('./lib/odc.jpeg'),
"mediaUrl": `https://youtu.be/BYPN6-gQJx0`,
"sourceUrl": ""
}}, quoted: 
mek })
}
...
${q}🔖 1.${prefix2}kick${q}
${q}🔖 2.${prefix2}promote${q}
${q}🔖 3.${prefix2}demote${q}
${q}🔖 4.${prefix2}welcome${q}

${q}🌹 OWNER${q}

${q}🔖 6.${prefix2}broadcast${q}/owner only

${q}🌹 STICKER${q}

${q}🔖 7.${prefix2}sticker${q}
${q}🔖 8.${prefix2}toimg${q}
...
`
sendButDocument(from, `${teks}`, `\n`, fs.readFileSync(`./lib/odc.jpeg`), {mimetype: Mimetype.pdf, thumbnail:fs.readFileSync(`./lib/odc.jpeg`), filename: `lower bot beta version`}, [{buttonId:`DEVELOPER`,buttonText:{displayText:'DEVELOEPER'},type:1}], {quoted:fvid
break
...
.on('end', function () {
console.log('Finish')
exec(`webpmux -set exif ${addMetadata(`LOWER`,`BOT`)} ${ran} -o ${ran}`, async (error) => {
//if (error) {
